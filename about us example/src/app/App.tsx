    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>
                ...
                return (
                  ...
                  >
                      ...
                      >
                        ...
                        <div className="relative z-10">
                          <div className={`flex items-center gap-3 mb-3 ${isEven ? 'md:justify-end' : 'md:justify-start'} justify-center`}>
                            ...
                            <h3 className="text-2xl" style={{ fontFamily: 'Playfair Display, serif', fontWeight: 600, color: '#d4af37' }}>
                              {milestone.title}
                            </h3>
                          </div>
                    ...
                    <div className="relative z-20 flex-shrink-0">
                      ...
                      >
                        <span className="text-xl font-bold text-[#d4af37]" style={{ fontFamily: 'Playfair Display, serif' }}>
                          {milestone.year}
                        </span>
                      </motion.div>
                    </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 text-gray-200 leading-relaxed text-lg">
                <p>
                  <span className="text-[#d4af37] font-semibold" style={{ fontFamily: 'Playfair Display, serif' }}>
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        >
          ...
          {/* Decorative Elements */}
          <div className="mt-16 flex justify-center gap-12 text-gray-500">
            <motion.div
      ...
      {/* Footer */}
      <footer className="relative border-t border-[#364c11]/30 py-8 px-6">
        <div className="absolute inset-0 bg-black" />
        <div className="relative z-10 text-center text-gray-500 text-sm">
          <p>© 2026 Bagecha by Adis Café. All rights reserved.</p>
          <p className="mt-2">Crafted with passion and love for our community</p>
        </div>
      </footer>
